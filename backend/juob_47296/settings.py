"""
Django settings for juob_47296 project.
...
WSGI_APPLICATION = 'juob_47296.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "juob_47296 API",
    "DESCRIPTION": "API documentation for juob_47296 App",
    "VERSION": "v1",
}
